...
def cutmix(images, labels):
    ...
    random_lbl = tf.keras.utils.to_categorical(label_to_index[train_images[idx].split('/')[-2]], len(train_dict))
...
with mirrored_strategy.scope():
    model, hist = run_expriment('efficient', split_train_dataset, split_val_dataset, batch_size=32, mc=True, epochs=100)
